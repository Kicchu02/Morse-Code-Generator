...
public class MainActivity extends AppCompatActivity {
    ...
    Button stringToMorse, morseToString;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stringToMorse = findViewById(R.id.buttonStringToMorse);
        morseToString = findViewById(R.id.buttonMorseToString);

        stringToMorse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, StringToMorseActivity.class));
            }
        });

        morseToString.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, MorseToStringActivity.class));
            }
        });
    }
